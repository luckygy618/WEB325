...
module.exports.initialize = function () {
    ...
    var fsdep = (resolve, reject) => {
        fs.readFile("./data/departments.json", (err, depdata) => {
            if (err) reject(err);
    ...
    return emp_promo.then(() => {
        return new Promise(fsdep)
    })
...
module.exports.getManagers = function () {
    return new Promise((resolve, reject) => {
        ...
        var is_manager = employees.filter((employees) => {
...
module.exports.getEmployeesByStatus = function (status) {
    ...
    return new Promise((resolve, reject) => {
        ...
        if (status.toString().substr(1, 4) == "Full" || status.toString().substr(0, 4) == "Full") {
            ...
            getdepartment = employees.filter((employees) => {
                return employees.status == 'Full Time'
            });
        }

        if (status.toString().substr(1, 4) == "Part" || status.toString().substr(0, 4) == "Part") {
            getdepartment = employees.filter((employees) => {
                return employees.status == 'Part Time'
            });
        }
...
module.exports.getEmployeesByDepartment = function (department) {
    return new Promise((resolve, reject) => {
        var getdepartment = employees.filter((employees) => {
...
module.exports.getEmployeesByManager = function (manager) {
    return new Promise((resolve, reject) => {
        var getmanager = employees.filter((employees) => {
            return employees.employeeManagerNum == manager
        });
...
module.exports.getEmployeeByNum = function (num) {
    return new Promise((resolve, reject) => {
        var getempNum = employees.filter((employees) => {
            return employees.employeeNum == num
        });
...
module.exports.updateEmployee = function (employeeData) {
    return new Promise((resolve, reject) => {
        let flag = false;
        var findemployeeNum = employees.filter((employees) => {
            return employees.employeeManagerNum == employeeData.employeeNum
        });
